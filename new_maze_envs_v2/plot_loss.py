"""
Plot Huber training loss vs. training iteration for the whole new_maze_envs_v2
...
The v2 sweep has no mc_ema_beta dimension, so there is a single flat set of
