"""Generate dijkstra_vs_transformer_costs.txt for the new_maze_envs_v3 alpha sweep.
...
The v3 sweep has no beta/EMA dimension (the veto uses the raw MC-dropout std),
...
ROOT = os.path.dirname(os.path.abspath(__file__))   # new_maze_envs_v3/
...
def main():
    ...
    lines.append("in each alpha_* subdirectory under new_maze_envs_v3/"
